...
// import 'package:jahanpay/models/service_category_model.dart';
...
//         value.data!.servicecategories!.removeWhere((category) =>
//             category.services == null || category.services!.isEmpty);
